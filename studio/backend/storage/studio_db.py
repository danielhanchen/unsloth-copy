...
def add_scan_folder_with_status(path: str) -> tuple[dict, bool]:
    ...
    # A registered folder joins the browse allowlist and model index, so it must be the
    # acting account's own (always true for the owner). Mirrors scan_folders.py.
