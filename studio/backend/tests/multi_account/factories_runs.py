...
# One content part no route can serve, refused before the preview lock and any checkpoint load.
PREVIEW_CHAT_BODY = {
    "model": PREVIEW_RUN,
...
def _create_research_run(account) -> None:
    """Create the thread, the user message and a planning run inside ``account``."""
